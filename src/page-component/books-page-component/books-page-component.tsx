import { Box, Button, Flex, Grid, HStack, Image, useColorModeValue, Text } from "@chakra-ui/react";
                  ...
                  <Box pos={"relative"}>
                     ...
                     >
                        <Box>
                           ...
                           <Text fontSize={"2xl"} fontWeight={"bold"} >{item.price.toLocaleString("en-US", { style: "currency", currency: "USD" })}</Text>
                        </Box>
                        <Button leftIcon={<AiFillLock />} colorScheme={"cyan"} >Buy</Button>
                     </HStack>
                  </Box>
               </motion.div>
            ))}
